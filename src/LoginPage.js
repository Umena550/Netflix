...
export default function LoginPage({ onLogin, onBack, prefillEmail = "" }) {
  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            ...
            <button
              ...
              onMouseEnter={(e) =>
                !loading && (e.currentTarget.style.background = "#f40612")
              }
              onMouseLeave={(e) =>
                !loading && (e.currentTarget.style.background = "#e50914")
              }
            >
            ...
            {!isSignUp && (
              ...
              >
                ...
                <span
                  style={{ color: "#b3b3b3", fontSize: 13, cursor: "pointer" }}
                >
                  Need help?
                </span>
              </div>
          ...
          >
            ...
            <span style={{ color: "#0071eb", cursor: "pointer" }}>
              Learn more.
            </span>
          </p>
          ...
          >
            💡 <strong style={{ color: "#ddd" }}>Demo:</strong> Any email + 6+
            char password works.
          </div>
        </div>
      </div>
      ...
      >
        <p style={{ color: "#737373", fontSize: 13, marginBottom: 14 }}>
